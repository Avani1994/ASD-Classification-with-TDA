"""
Code from: https://github.com/c-hofer/chofer_torchex/blob/master/chofer_torchex/nn/slayer.py
...
class SLayerRational(Module):
    ...
    def __init__(self, n_elements: int,
        ...
        sharpness_init = parameter_init_from_arg(arg=sharpness_init,
                                                 size=(1,) if self.share_sharpness else (
                                                 self.n_elements, self.point_dimension),
                                                 default=torch.ones,
